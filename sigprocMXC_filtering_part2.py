# jupyter nbconvert sigprocMXC_filtering_part2.ipynb --to python
import numpy as np
...
filter_freqs = [0, lower_bnd * (1 - lower_trans), lower_bnd, upper_bnd, upper_bnd + upper_bnd * upper_trans,
                samprate / 2]
